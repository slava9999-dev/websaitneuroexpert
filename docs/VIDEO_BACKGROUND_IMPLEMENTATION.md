...
1. **`frontend/src/components/VideoBackground.jsx`** — основной компонент видеофона
...
2. **Hero.jsx** - Updated to include video background
   - Подключён компонент `frontend/src/components/VideoBackground.jsx`
   - Maintained existing animations and layout

3. **`frontend/src/utils/videoUtils.js`** — утилиты для оптимизации видео
